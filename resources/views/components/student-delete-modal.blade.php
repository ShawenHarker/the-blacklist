...
<div x-data="{ show: false }" x-cloak>
    <x-secondary-button @click="show = true" class="text-red-600 ml-1">Delete</x-secondary-button>
    <div
        x-show="show"
...
<script>
    function deleteStudentTeacher() {
        fetch(`{{ route('student.destroy', ['studentTeacher' => $studentTeacher]) }}`, {
            method: 'DELETE',
            headers: {
